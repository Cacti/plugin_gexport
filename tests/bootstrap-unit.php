 ...
 * Test bootstrap.
 *
 * gexport's sources expect to be included by Cacti, which has already
 ...
 * gexport's source files build include paths from it at runtime.
 */
 ...
 * @return void
 */
function gexport_test_load($path) {
	global $config;
